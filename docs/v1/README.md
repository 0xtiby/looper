# Looper v1 Documentation (Archived)

> This document is archived for reference. Looper v2 is the current major
> version and is documented in the root [README.md](../../README.md).
